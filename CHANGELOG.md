...
- Rope, Robe, Ink, Ink Pen, Bedroll, Blanket, Tinderbox, Caltrops, Crowbar,
  ...
  repaired when the world loads and again after each restock. A merchant
  dragged in fresh gets a new stock table with the version in its name, which
  draws the standalone items. (#89)
